<template>
  <v-layout align-start>
    <v-flex>
        ...
        <v-dialog v-model="dialog" max-width="500px">
          ...
          <v-card>
              ...
              <v-container>
                <v-row>
                  <v-col cols="6" sm="6" md="6">
                    <v-text-field v-model="codigo" label="Código" @keyup.enter="guardar"></v-text-field>
                  </v-col>
                  <v-col cols="6" sm="6" md="6">
                    <v-select v-model="idcategoria" :items="categorias" label="Categoría"></v-select>
                  </v-col>
                  <v-col cols="12" sm="12" md="12">
                    <v-text-field v-model="nombre" label="Nombre" @keyup.enter="guardar"></v-text-field>
                  </v-col>
                  <v-col cols="6" sm="6" md="6">
                    <v-text-field type="number" v-model="stock" label="Stock" @keyup.enter="guardar"></v-text-field>
                  </v-col>
                  <v-col cols="6" sm="6" md="6">
                    <v-text-field type="number" v-model="precioVenta" label="Precio" @keyup.enter="guardar"></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="12" md="12">
                    <v-text-field v-model="descripcion" label="Descripción" @keyup.enter="guardar"></v-text-field>
                  </v-col>
            ...
            <v-card-actions>
              ...
              <v-btn color="info" text @click="guardar" @keyup.enter="guardar">
                Guardar
              </v-btn>
            </v-card-actions>
          </v-card>
      ...
      <!-- DATA TABLE -->
      <v-data-table :headers="headers" :items="articulos" :search="search" class="elevation-1" :items-per-page="9">
        <template v-slot:top>
        </template>
  ...
  methods: {
    ...
    eliminar() {
      ...
      var config = {
        ...
        url: 'api/Articulos/Eliminar/' + this.id,
        headers: {
