  ...
  methods: {
    ...
    agregarDetalle(data = []) {
      ...
      if (this.encuentra(data['idarticulo'])) {
        ...
        this.detalles.push(
          { idarticulo: data['idarticulo'], articulo: data['nombre'], cantidad: 1, precio: data['precioVenta'], descuento: 0 });
      }
    },
    ...
    /*activar() {
      let me = this;
      axios.put('api/Ventas/Activar/' + this.adId, {}).then(function (response) {
        me.adModal = 0;
        me.adAccion = 0;
        me.adNombre = "";
        me.adId = "";
